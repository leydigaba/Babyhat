...
| -- | -- | -- | -- | -- | -- |
| 1 | Padres | Insertar nuevo padre | Inserta un nuevo usuario en la tabla padres | Fácil | Leydi |
| 2 | Padres | Vizualizar padre | Vizualizar la información del padre | Fácil | Leydi |
| 3 | Padres | Editar padre | Actualiza los valores de un padre existente | Fácil | Leydi |
| 4 | Padres | Iniciar sesión | Verifica las credenciales en la tabla padres | Fácil | Leydi |
| 5 | Padres | Eliminar padre | Actualiza el estatus de un padre existente | Fácil | Leydi |
| 6 | Padres | Recuperar contraseña | Validar correo registrado para recuperar contraseña | Media | Eduardo |
| 7 | Padres | Agregar nuevo bebé | Inserta un nuevo bebé en la tabla bebes | Fácil | Leydi |
| 8 | Padres | Vizualizar bebé | Vizualizar la información del bebé | Fácil | Leydi |
| 9 | Padres | Editar bebé | Actualiza los valores de un bebé existente | Fácil | Leydi |
| 10 | Padres | Eliminar bebé | Actualiza el estatus de un bebé existente | Fácil | Leydi |
| 11 | Padres | Vizualizar seguimiento del bebé | Vizualizar la información de la tabla seguimiento | Fácil | Eduardo |
| 12 | Padres | Insertar nuevo peso del bebé | Inserta un nuevo peso en la tabla seguimiento | Fácil | Eduardo |
| 13 | Padres | Insertar nueva estatura del bebé | Inserta una nueva estatura en la tabla seguimiento | Fácil | Eduardo |
| 14 | Padres | Insertar nuevo IMC del bebé | Inserta un nuevo IMC en la tabla seguimiento | Fácil | Eduardo |
| 15 | Padres | Vizualizar peso del bebé | Vizualizar la columna peso de la tabla seguimiento de un bebé existente | Fácil | Eduardo |
| 16 | Padres | Vizualizar estatura del bebé | Vizualizar la columna estatura de la tabla seguimiento de un bebé existente | Fácil | Eduardo |
| 17 | Padres | Vizualizar IMC del bebé | Vizualizar la columna imc de la tabla seguimiento de un bebé existente | Fácil | Eduardo |
| 18 | Padres | Editar peso del bebé | Actualiza el peso de un bebé existente | Fácil | Eduardo |
| 19 | Padres | Editar estatura del bebé | Actualiza la estatura de un bebé existente | Fácil | Eduardo |
| 20 | Padres | Editar IMC del bebé | Actualiza el IMC de un bebé existente | Fácil | Eduardo |
| 21 | Padres | Eliminar peso del bebé | Elimina el peso de un bebé existente | Fácil | Eduardo |
| 22 | Padres | Eliminar estatura del bebé | Elimina la estatura de un bebé existente | Fácil | Eduardo |
| 23 | Padres | Eliminar IMC del bebé | Elimina el IMC de un bebé existente | Fácil | Eduardo |
| 24 | Padres | Abrir nuevo chat | Limpiar vizualización e inserta un nuevo chat al padre en la tabla chats | Compleja | Eduardo |
| 25 | Padres | Eliminar chat | Elimina el chat de un padre existente | Fácil | Jonathan |
| 26 | Padres | Enviar pregunta | Inserta una pregunta y fecha al chat en la tabla mensajes | Fácil | Jonathan |
| 27 | Padres | Editar pregunta | Actualiza la pregunta de un chat existente | Fácil | Jonathan |
| 28 | Padres | Eliminar pregunta | Elimina la pregunta de un chat existente | Fácil | Eduardo |
| 29 | Padres | Recibir respuesta | Inserta una respuesta al chat en la tabla mensajes | Fácil | Eduardo |
...
| 66 | Administradores | Eliminar estatura del bebé | Elimina la estatura de un bebé existente | Fácil | Leydi |
